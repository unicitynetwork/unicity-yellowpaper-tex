...
Given an inclusion proof $\pi^\mathsf{inc}=(C^\mathsf{inc},UC)$ whose authenticated terminal is $(\mathsf{sid},\txhash)$, the \emph{system time} used for predicate evaluation is extracted as
\[
