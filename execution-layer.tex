...
\begin{enumerate}
	...
	\item \textbf{Mint each new token} $j \in \{1, \ldots, k\}$: create a mint transaction for token $\mathsf{id}_j$ with $\mathsf{reason}$ set to a \emph{split reason proof} containing:
	\begin{itemize}
