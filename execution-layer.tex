...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item $\mathsf{reason}$ -- Mint Reason, content depends on the token type, justifying the act of minting this token, e.g., proving the authority of minting tokens of this specific type
		\item $\predi'$ -- spending predicate of the first owner
		\item $\auxd'$ -- auxiliary data (application-specific; e.g. asset value for fungible tokens)
	\end{itemize}
