...
\begin{enumerate}[nosep]
  ...
  \item Constructs the payload tree:
    \begin{enumerate}[nosep]
      \item Chooses a unique reward token identifier $\mathsf{tokenId}_\mathsf{reward}$ and computes leaf $0 = H(\mathsf{tokenId}_\mathsf{reward})$.
      \item If a new Unicity Trust Base entry $T_e$ is available and not yet published in the chain, sets leaf $1 = H(T_e)$; otherwise leaf $1 = \zerohash$.
