...
\begin{algorithm}[!htbp]
  ...
  \begin{algorithmic}[0]
    \Function{VerifyRewardMint}{$D_\mathsf{mint}, \mathcal{T}$}
      ...
      \State ensure($\ell_0 = H(H(D_\mathsf{mint}.\mathsf{salt}, D_\mathsf{mint}.\alpha))$) \Comment{Reward commitment matches the token id generated from the salt revealed in the mint transaction}
      \State
